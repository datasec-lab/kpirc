...
CSV_PATH="$RESULTS_DIR/quick_check.csv"
...
main() {
  ...
  run_case "TCWKPIR" 1 12 64 "$warmup_runs" "$measured_runs"
  run_case "TCAKPIR" 1 12 64 "$warmup_runs" "$measured_runs"
  run_case "TCAKPIR_OPT" 1 12 64 "$warmup_runs" "$measured_runs"
